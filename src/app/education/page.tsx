        ...
        <div className="w-full h-fit flex">
          ...
          >
            ...
            <p className=" font-poppins text-base w-full text-primary  max-sm:text-xs">
              I am currently pursuing my Master's degree in Artificial Intelligence and Machine Learning at the Adelaide University, Australia. This program is designed to equip me with advanced knowledge and skills in AI and ML, preparing me for a career in this rapidly evolving field.
            </p>
          </FramerWrapper>
        </div>
        <div className="w-full h-fit flex">
